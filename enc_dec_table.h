/*
 * 子密钥K(i)的获取 密钥为K 抛弃第6,16,24,32,40,48,64位
...
/* C1,D1为第一次左移后得到,进行PC2选位,得到48位输出K1 */
...
/* F函数,32位的R0进行E变换,扩为48位输出 (R1~R16) */
...
/* 对C0,D0分别进行左移,共16次,左移位数与下面对应 */
static char move_table[16]={
	 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1
};

/* 16个48位子密钥 */
static bool sub_key[16][48];
